...
<div class="hdr">
<h1 id="dash-title"><span>&#9670;</span> APOTHECARY</h1>
...
<script>
var A='/api';
var RESOURCE='medications';
var TITLE_FIELD='name';

var fields=[{"name": "id", "label": "Id", "type": "text"}, {"name": "name", "label": "Name", "type": "text"}, {"name": "dosage", "label": "Dosage", "type": "text"}, {"name": "frequency", "label": "Frequency", "type": "text"}, {"name": "prescriber", "label": "Prescriber", "type": "text"}, {"name": "pharmacy", "label": "Pharmacy", "type": "text"}, {"name": "refill_date", "label": "Refill Date", "type": "date"}, {"name": "notes", "label": "Notes", "type": "textarea"}, {"name": "active", "label": "Active", "type": "integer"}, {"name": "created_at", "label": "Created At", "type": "text"}];
